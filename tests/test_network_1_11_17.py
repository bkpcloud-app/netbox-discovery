...
def test_01_release_versions_include_1_11_17_or_newer():
...
def test_07_historical_patch_documentation_remains_available():
    assert "# netbox-discovery 1.11.17" in read("docs/PATCH-1.11.17.md")
    assert "## V1.11.17" in read("RELEASE-NOTES.md")
